...
bool SymbolAutomaton::is_deterministic()
{
...
vector<pair<set<unsigned>, vector<set<unsigned>>>> SymbolAutomaton::get_rel_table_deterministic()
{
...
SymbolAutomaton SymbolAutomaton::get_deterministic_automaton()
{
	...
	SymbolAutomaton new_automaton(new_states[0], new_states, alphabet);
...
vector<vector<bool>> SymbolAutomaton::get_rel_table_minimalistic()
{
	if (not is_deterministic())
#ifdef _WIN32
		throw exception("SymbolAutomaton is not deterministic");
#elif __linux__
		throw exception();
#endif
...
SymbolAutomaton SymbolAutomaton::get_minimal_automaton()
{
	if (not is_deterministic())
#ifdef _WIN32
		throw exception("SymbolAutomaton is not deterministic");
	...
	SymbolAutomaton new_automaton{ new_initial_state, new_states, alphabet };
...
bool SymbolAutomaton::test(std::string word)
{
